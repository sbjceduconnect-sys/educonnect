"""
Django settings for EduConnect backend.
"""
import os
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'core.authentication.StudentSessionJWTAuthentication',
    ],
...
# ── Institutional Codes ────────────────────────────────────────
ADMIN_CODE   = os.getenv('ADMIN_CODE',   'SBJC-ADMIN-2026')
TEACHER_CODE = os.getenv('TEACHER_CODE', 'SBJC-TEACH-2026')
BULK_DELETE_SECURITY_CODE = os.getenv('BULK_DELETE_SECURITY_CODE', 'SBJC-DELETE-CONFIRM-2026')
